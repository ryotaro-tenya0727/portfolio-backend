...
RSpec.describe "署名URLの取得 Api::V1::User::External::Aws::S3::PresignedUrl::DiaryVideosController", type: :request do
  ...
  describe 'ユーザーがS3へアップロードするための署名URLを取得 POST /api/v1/user/external/aws/s3/presigned_url/profiles' do
    ...
    let(:http_request) { post '/api/v1/user/external/aws/s3/presigned_url/profiles', request_hash }
